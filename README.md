...
If you want to know, what it will going to look like, checkout the **[documentation draft](https://github.com/gehrisandro/pest-docs/blob/add-mutation-testing/mutation-testing.md)**.
